...
if __name__=='__main__':
    ...
    # parser.add_argument('--results_file', type=str, default='output/results_original_motivation_gpt4o-mini.json',
    ...
    parser.add_argument('--geonames_username', type=str, default="zhenghua", #Insert here your GeoName username. Necessary for location only
