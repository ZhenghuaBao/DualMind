...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--forgery_detection_explanation",
        type=str,
        default="dataset/forgery_detection/FakeShield_output.jsonl",
        help="Path to the forgery detection explanation file.",
    )
    parser.add_argument(
        "--forgery_detection_path",
        type=str,
        default="dataset/forgery_detection/FakeShield_output",
    ...
    # NOTE: Uncomment if forgery detection is desired
    # def load_jsonl_to_json(jsonl_path):
    #     with open(jsonl_path, "r", encoding="utf-8") as f:
    #         data = [json.loads(line) for line in f]
    #     return data

    # forgery_detection_explanation = load_jsonl_to_json(
    #     args.forgery_detection_explanation
    # )
