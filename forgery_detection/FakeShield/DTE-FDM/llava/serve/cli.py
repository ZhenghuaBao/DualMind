...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/data/xxp0/FakeShield/weight/fakeshield-v1-22b/DTE-FDM")
    parser.add_argument("--model-base", type=str, default=None)  # This is optional, keep it None by default
    parser.add_argument("--DTG-path", type=str, default="/data/xxp0/FakeShield/weight/fakeshield-v1-22b/DTG.pth")
    parser.add_argument("--image-path", type=str, default="/data/xxp0/FakeShield/playground/images/1.jpg")
    parser.add_argument("--output-path", type=str, default="/data/xxp0/FakeShield/playground/DTE-FDM_output.jsonl")
