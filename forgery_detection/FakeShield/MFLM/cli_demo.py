...
def parse_args(args):
    ...
    parser.add_argument("--version", type=str, default="/data/xxp0/FakeShield/weight/fakeshield-v1-22b/MFLM", 
                        help="Path to the model version directory")
    parser.add_argument("--DTE-FDM-output", type=str, default="/data/xxp0/FakeShield/playground/DTE-FDM_output.jsonl", 
                        help="Path to the DTE-FDM output file")
    parser.add_argument("--MFLM-output", type=str, default="/data/xxp0/FakeShield/playground/MFLM_output", 
                        help="Path to the MFLM output file")    
    ...
    parser.add_argument("--vision-tower", default="./weight/clip-vit-large-patch14-336", type=str)
